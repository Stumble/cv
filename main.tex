...
\begin{tightemize}
\item Domain Name Service for Named Data Networking (NDNS) EXPAND THIS PART. Links: \href{https://named-data.net/publications/2017-icccn-ndns/}{paper} \textbullet{} \href{https://gerrit.named-data.net/#/q/project:ndns}{gerrit}
\item Implementation and evaluation of several NDN cache policies based on NDNsim ADD LINK.
...
\descript{\break Software verification and visualization, IoT, Hardware}
\begin{tightemize}
\item TrustCoq
\item DUCK
